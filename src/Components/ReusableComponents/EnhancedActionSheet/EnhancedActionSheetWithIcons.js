...
const video = require('../../assets/video_icon.png');
const clinic = require('../../assets/clinic_icon.png');

const EnhancedActionSheetWithIcons = props => {
  const {
    visible,
    title,
    cancelBtnText,
  ...
  const _renderOption = (e, i, dataLength) => (
    <TouchableOpacity
      ...
      {i === 0 ? (
        <Image source={clinic} resizeMode="contain" style={styles.icon} />
      ) : (
        <Image source={video} resizeMode="contain" style={styles.icon} />
      )}
...
export default EnhancedActionSheetWithIcons;
